...
| 5 | **R&D / Research mode** (logging, analytics dashboard, SME tagging, prompt A/B testing) | Closes the improvement loop — the SME learns from real conversations and iterates the method | Dev + SME | [`docs/developer/research-mode.md`](./docs/developer/research-mode.md); canonical lit review at [`paper/survey/main.pdf`](./paper/survey/main.pdf) ([`source`](./paper/survey/main.tex)) |
