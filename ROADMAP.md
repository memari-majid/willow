...
| 5 | **R&D / Research mode** (logging, analytics dashboard, SME tagging, prompt A/B testing) | Closes the improvement loop — the SME learns from real conversations and iterates the method | Dev + SME | [`docs/developer/research-mode.md`](./docs/developer/research-mode.md); canonical lit review framed for *JMIR Mental Health* submission at [`paper/jmir-mental-health/main.pdf`](./paper/jmir-mental-health/main.pdf) ([`source`](./paper/jmir-mental-health/main.tex)) |
