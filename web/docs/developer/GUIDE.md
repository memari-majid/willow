...
| Give the bot an AI tool | follow [add-a-tool](./add-a-tool.md); CBT tools live in `src/lib/ai/tools/cbt-tools.ts` |
| Auth, chat persistence, safety, RAG | [`agent-chatbot-playbook.md`](./agent-chatbot-playbook.md) · [`ROADMAP.md`](../ROADMAP.md) Phase 4 |
